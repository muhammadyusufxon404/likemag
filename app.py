...
# def print_receipt():
#     tolov_id = request.form.get('id')
#     if not tolov_id:
#         return "ID kiritilmadi", 400
...
#     if not tolov:
#         return "To‘lov topilmadi", 404

#     # tolov: (id, ismi, tolov, kurs, oy, izoh, admin, oqituvchi, vaqt, tolov_turi)
#     kvitansiya_matni = (
#         f"--- Magistr To‘lov Kvittansiyasi ---\n"
#         f"ID: {tolov[0]}\n"
#         f"O‘quvchi: {tolov[1]}\n"
#         f"To‘lov: {tolov[2]} so‘m\n"
#         f"Kurs: {tolov[3]}\n"
#         f"Oy: {tolov[4]}\n"
#         f"Izoh: {tolov[5] or 'Yo‘q'}\n"
#         f"Admin: {tolov[6]}\n"
#         f"O‘qituvchi: {tolov[7]}\n"
#         f"Sana: {tolov[8]}\n"
#         f"To‘lov turi: {tolov[9] or '-'}\n"
#         f"-----------------------------"
#     )

#     # Hozirgi holatda matnni HTML <pre> tagida qaytaramiz.
#     # Bu yerga printerga yuborish kodi ham joylashtirilishi mumkin.
#     return f"<pre>{kvitansiya_matni}</pre>"
